...
test('ecluid distance pl infinit test 1', () => {
    expect(ecluid_distance_pl_inf(point_test_2, lineseg_test_3))
        .toStrictEqual(1)
});

test('ecluid distance pl infinit test 2', () => {
    expect(ecluid_distance_pl_inf(point_test_1, lineseg_test_2))
        .toStrictEqual(1)
});

test('ecluid distance pl infinit test 3', () => {
    expect(custom_round(ecluid_distance_pl_inf(point_test_3, lineseg_test_1), 2))
        .toStrictEqual(0.71)
});
